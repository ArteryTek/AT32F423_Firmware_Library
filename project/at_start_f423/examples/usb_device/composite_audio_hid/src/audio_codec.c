...
#define I2Cx_CLKCTRL                     0x80504C4E
...
void codec_i2s_init(audio_codec_type *param)
{
  ...
  gpio_pin_mux_config(I2S1_GPIO, I2S1_WS_PIN_SOURCE, I2S1_WS_GPIO_MUX);

  /* i2s1 ck pins */
  gpio_init_struct.gpio_pull           = GPIO_PULL_DOWN;
  gpio_init_struct.gpio_pins           = I2S1_CK_PIN;
  gpio_init(I2S1_GPIO, &gpio_init_struct);
  gpio_pin_mux_config(I2S1_GPIO, I2S1_CK_PIN_SOURCE, I2S1_CK_GPIO_MUX);
  ...
  gpio_init_struct.gpio_drive_strength = GPIO_DRIVE_STRENGTH_MODERATE;
  gpio_init(I2S1_GPIO, &gpio_init_struct);
  gpio_pin_mux_config(I2S1_GPIO, I2S1_SD_PIN_SOURCE, I2S1_SD_GPIO_MUX);

  /* i2s2 ws pins */
  gpio_init_struct.gpio_pull           = GPIO_PULL_UP;
  gpio_init_struct.gpio_pins           = I2S2_WS_PIN;
  gpio_init(I2S2_GPIO, &gpio_init_struct);
  gpio_pin_mux_config(I2S2_GPIO, I2S2_WS_PIN_SOURCE, I2S2_WS_GPIO_MUX);

  /* i2s2 ck pins */
  gpio_init_struct.gpio_pull           = GPIO_PULL_DOWN;
  gpio_init_struct.gpio_pins           = I2S2_CK_PIN;
  gpio_init(I2S2_GPIO, &gpio_init_struct);
  gpio_pin_mux_config(I2S2_GPIO, I2S2_CK_PIN_SOURCE, I2S2_CK_GPIO_MUX);

  /* i2s2 sd pins slave rx */
  gpio_init_struct.gpio_pull           = GPIO_PULL_UP;
  gpio_init_struct.gpio_pins           = I2S2_SD_PIN;
  gpio_init(I2S2_GPIO, &gpio_init_struct);
  gpio_pin_mux_config(I2S2_GPIO, I2S2_SD_PIN_SOURCE, I2S2_SD_GPIO_MUX);
  ...
  dmamux_init(DMA1MUX_CHANNEL4, DMAMUX_DMAREQ_ID_SPI2_RX);
