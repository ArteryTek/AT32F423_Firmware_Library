...
/** @addtogroup 423_ADC_tmr_trigger_automatic_preempted ADC_tmr_trigger_automatic_preempted
  * @{
  */
...
static void adc_config(void)
{
  ...
  adc_preempt_conversion_trigger_set(ADC1, ADC_PREEMPT_TRIG_TMR1CH2, ADC_PREEMPT_TRIG_EDGE_NONE);
