...
/** @addtogroup 423_ADC_voltage_monitoring ADC_voltage_monitoring
  * @{
  */
...
int main(void)
{
  ...
  while(1)
  {
    ...
    delay_sec(1);
    if(error_times_index != (adc1_overflow_flag + vmor_flag_index)) 
    {
      /* printf flag when error occur */
      error_times_index = adc1_overflow_flag + vmor_flag_index;
      at32_led_on(LED3);
      at32_led_on(LED4);
