/**
  ...
  */
  ...
  this demo is based on the at-start board, in this demo, shows how to abort the ongoing conversion.
  ...
  for more detailed information. please refer to the application note document AN0161.
