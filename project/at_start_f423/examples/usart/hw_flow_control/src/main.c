...
/** @addtogroup 423_USART_hw_flow_control USART_hw_flow_control
  * @{
  */
...
void usart_configuration(void)
{
  ...
  /* configure the usart2 tx, rx, cts and rts pin */
  ...
  gpio_pin_mux_config(GPIOD, GPIO_PINS_SOURCE3, GPIO_MUX_7);
  gpio_pin_mux_config(GPIOD, GPIO_PINS_SOURCE4, GPIO_MUX_7);
