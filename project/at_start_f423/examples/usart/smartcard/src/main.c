...
/** @addtogroup 423_USART_smartcard USART_smartcard
  * @{
  */
...
void usart_configuration(void)
{
  ...
  gpio_pin_mux_config(SC_USART_CLK_PORT, GPIO_PINS_SOURCE4, GPIO_MUX_7);
  ...
  gpio_pin_mux_config(SC_USART_TX_PORT, GPIO_PINS_SOURCE2, GPIO_MUX_7);
  ...
  scfg_exint_line_config(SC_OFF_PORTSOURCE, SC_OFF_PINSOURCE);
