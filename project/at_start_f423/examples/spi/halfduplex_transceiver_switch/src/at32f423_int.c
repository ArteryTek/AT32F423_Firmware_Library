...
/** @addtogroup 423_SPI_halfduplex_transceiver_switch
  * @{
  */
...
{
  if(SPI3->ctrl2_bit.tdbeie != RESET)
  {
  ...
  if(SPI3->ctrl2_bit.rdbfie != RESET)
  {
    if(spi_i2s_flag_get(SPI3, SPI_I2S_RDBF_FLAG) != RESET)
    {
