...
/** @addtogroup 423_SPI_ti_fullduplex_dma SPI_ti_fullduplex_dma
  * @{
  */
...
static void dma_config(void)
{
  ...
  /* use dma1_channel4 as spi3 receive channel */
...
static void gpio_config(void)
{
  ...
  gpio_pin_mux_config(GPIOB, GPIO_PINS_SOURCE12, GPIO_MUX_5);
