...
/** @addtogroup 423_WWDT_wwdt_reset WWDT_wwdt_reset
  * @{
  */
...
int main(void)
{
  ...
  /* enable wwdt
   ...
   timeout = 64 * (32768 / 72000000 ) = 0.0174s = 29.1ms
   window  = 16 * (32768 / 72000000 ) = 0.0044s = 5.5ms
  ...
  */
  ...
  while(1)
  {
    ...
    /* the reload time must within the window (10ms > 5.5ms) */
    delay_ms(10);
