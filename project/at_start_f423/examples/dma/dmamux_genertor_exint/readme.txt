/**
  ...
  */
  ...
  embedded sram memory.pa0 is input trigger signal for dmamux genertor channel1,
  ...
  for more detailed information. please refer to the application note document AN0160.
