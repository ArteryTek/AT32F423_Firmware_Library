...
/** @addtogroup 423_TMR_complementary_signals TMR_complementary_signals
  * @{
  */
...
int main(void)
{
  ...
  1/ generate 3 complementary pwm signals with 3 different duty cycles:
    tmr1clk is fixed to apb2_freq, the tmr1 prescaler is equal to 0 so the
    tmr1 counter clock used is apb2_freq.

    the objective is to generate pwm signal at 17.57 khz:
    - tmr1_period = (apb2_freq / 17570) - 1
  ...
  2/ insert a dead time equal to 11/apb2_freq ns
  3/ configure the break feature, active at high level, and using the automatic
     output enable feature
  4/ use the locking parameters level1.
  ----------------------------------------------------------------------- */
  /* compute the value to be set in arr regiter to generate signal frequency at 17.57 khz */
  timerperiod = ((crm_clocks_freq_struct.apb2_freq) / 17570 ) - 1;
