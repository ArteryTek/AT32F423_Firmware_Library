...
/** @addtogroup 423_TMR_pwm_input_dma TMR_pwm_input_dma
  * @{
  */
...
int main(void)
{
  ...
  dmamux_init(DMA1MUX_CHANNEL2, DMAMUX_DMAREQ_ID_TMR1_CH1);
  dmamux_init(DMA1MUX_CHANNEL3, DMAMUX_DMAREQ_ID_TMR1_CH2);
...
void DMA1_Channel2_IRQHandler(void)
{
  ...
  dutycycle = duty_result / SAMPLING_NUM;
